...
public class SoldItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewSold);
    ...
    private void loadProducts() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "http://10.2.7.50:8080/android/v1/mySoldItems.php?buyer_fk=" + id + "" , null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            ProductAdapter adapter = new ProductAdapter(SoldItems.this, productArrayList);
