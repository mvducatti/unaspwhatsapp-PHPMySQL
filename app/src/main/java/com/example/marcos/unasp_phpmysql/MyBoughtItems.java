...
public class MyBoughtItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_bought_items);

        recyclerView = findViewById(R.id.recyclerViewBoughtItems);
    ...
    private void loadProducts() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "http://10.2.7.50:8080/android/v1/myBoughtItems.php?buyer_fk=" + id + "" , null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            ProductAdapter adapter = new ProductAdapter(MyBoughtItems.this, productArrayList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getApplicationContext(), "Você ainda não reservou nada", Toast.LENGTH_LONG).show();
                    }
                });
