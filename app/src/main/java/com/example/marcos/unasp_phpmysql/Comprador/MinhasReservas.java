...
public class MinhasReservas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recylerViewMyReservations);
    ...
    private void loadProducts() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "http://10.2.7.50:8080/android/v1/getMyReservations.php?buyer_fk=" + id + "" , null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            ProductAdapter adapter = new ProductAdapter(MinhasReservas.this, productArrayList);
